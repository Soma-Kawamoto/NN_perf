...
def main():
    ...
    B_MAX = 2.0
    FREQ_ARRAY = [20, 50, 100, 200, 400, 600, 800, 1000]
    N_POINTS = 1024
    STEP_SIZES_TO_PROCESS = [0.05, 0.1]
    ...
    INPUT_BASE_FOLDER = os.path.join(base_dir,  "3.Fourier Transform Correction")
    OUTPUT_BASE_FOLDER = os.path.join(base_dir, "7.reference data")
    # ----------------------------------------------------------------------
