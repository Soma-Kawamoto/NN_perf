...
INTERPOLATION_METHOD = 'akima'  # 補間手法
...
INPUT_FOLDER = os.path.join(script_dir, "1.Raw Normal Magnetization Curve")
OUTPUT_FOLDER = os.path.join(script_dir, "2.Akima spline interpolation")
# ----------------------------------------------------------------------
